...
public class GameLogic {
  ...
  public  boolean updateGameBoard(int row , int col){
        ...
        if(gameBoard[row-1] [col-1] == 0){
         ...
         if(player == 1){
             playerTern.setText((playerName[1] +" 's Turn"));
         }else {
   ...
   public boolean winnerCheck(){
       ...
       if(isWinner){
           ...
           playerTern.setText((playerName[player-1] + "WON!!!!"));
           return true;
       }
  ...
  public void resetGame(){
    ...
    public void setHomeBYN(Button homeBTN) {
        this.homeBTN = homeBTN;
    }

    public void setPlayerTern(TextView playerTern) {
